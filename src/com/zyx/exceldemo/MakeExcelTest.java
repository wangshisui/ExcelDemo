...
/**
 * @Author:zhangyx
 * @Date:Created in 21:082018/11/12
 * @Modified By:
 */
public class MakeExcelTest {
    ...
    protected static List<User> getUsers() {
        ...
        User user2 = new User("lisi", "141242");
        User user3 = new User("wangwu", "386002");
        users.add(user1);
        users.add(user2);
        users.add(user3);
        return users;
    ...
    public static void main(String[] args) {
        ...
        //将文件保存到指定的位置
        try {
            FileOutputStream fos = new FileOutputStream("E:\\master\\ExcelDemo\\user.xls");
            workbook.write(fos);
